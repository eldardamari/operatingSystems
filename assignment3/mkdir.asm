...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    1047:	e8 f8 02 00 00       	call   1344 <mkdir>
    ...
    1066:	c7 44 24 04 3a 18 00 	movl   $0x183a,0x4(%esp)
    106d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    13f2:	8a 80 9c 2a 00 00    	mov    0x2a9c(%eax),%al
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1551:	75 25                	jne    1578 <printf+0x11c>
          s = "(null)";
    1553:	c7 45 f4 56 18 00 00 	movl   $0x1856,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    161b:	a1 b8 2a 00 00       	mov    0x2ab8,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    16e6:	a3 b8 2a 00 00       	mov    %eax,0x2ab8
}
    16eb:	c9                   	leave  
    16ec:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    173e:	a1 b8 2a 00 00       	mov    0x2ab8,%eax
}
    1743:	c9                   	leave  
    1744:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1758:	a1 b8 2a 00 00       	mov    0x2ab8,%eax
    175d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1760:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1764:	75 23                	jne    1789 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
    1766:	c7 45 f0 b0 2a 00 00 	movl   $0x2ab0,-0x10(%ebp)
    176d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1770:	a3 b8 2a 00 00       	mov    %eax,0x2ab8
    1775:	a1 b8 2a 00 00       	mov    0x2ab8,%eax
    177a:	a3 b0 2a 00 00       	mov    %eax,0x2ab0
    base.s.size = 0;
    177f:	c7 05 b4 2a 00 00 00 	movl   $0x0,0x2ab4
    1786:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    17dc:	a3 b8 2a 00 00       	mov    %eax,0x2ab8
      return (void*)(p + 1);
    ...
    if(p == freep)
    17e9:	a1 b8 2a 00 00       	mov    0x2ab8,%eax
