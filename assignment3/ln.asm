...
main(int argc, char *argv[])
{
  ...
  if(argc != 3){
    ...
    100f:	c7 44 24 04 0f 18 00 	movl   $0x180f,0x4(%esp)
    1016:	00 
    1017:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    101e:	e8 25 04 00 00       	call   1448 <printf>
    exit();
  ...
  if(link(argv[1], argv[2]) < 0)
    ...
    103f:	e8 e4 02 00 00       	call   1328 <link>
    ...
    1060:	c7 44 24 04 22 18 00 	movl   $0x1822,0x4(%esp)
    1067:	00 
    1068:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    106f:	e8 d4 03 00 00       	call   1448 <printf>
  exit();
    1074:	e8 4f 02 00 00       	call   12c8 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    13de:	8a 80 7c 2a 00 00    	mov    0x2a7c(%eax),%al
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    153d:	75 25                	jne    1564 <printf+0x11c>
          s = "(null)";
    153f:	c7 45 f4 36 18 00 00 	movl   $0x1836,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1607:	a1 98 2a 00 00       	mov    0x2a98,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    16d2:	a3 98 2a 00 00       	mov    %eax,0x2a98
}
    16d7:	c9                   	leave  
    16d8:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    172a:	a1 98 2a 00 00       	mov    0x2a98,%eax
}
    172f:	c9                   	leave  
    1730:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1744:	a1 98 2a 00 00       	mov    0x2a98,%eax
    1749:	89 45 f0             	mov    %eax,-0x10(%ebp)
    174c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1750:	75 23                	jne    1775 <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
    1752:	c7 45 f0 90 2a 00 00 	movl   $0x2a90,-0x10(%ebp)
    1759:	8b 45 f0             	mov    -0x10(%ebp),%eax
    175c:	a3 98 2a 00 00       	mov    %eax,0x2a98
    1761:	a1 98 2a 00 00       	mov    0x2a98,%eax
    1766:	a3 90 2a 00 00       	mov    %eax,0x2a90
    base.s.size = 0;
    176b:	c7 05 94 2a 00 00 00 	movl   $0x0,0x2a94
    1772:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    17c8:	a3 98 2a 00 00       	mov    %eax,0x2a98
      return (void*)(p + 1);
    ...
    if(p == freep)
    17d5:	a1 98 2a 00 00       	mov    0x2a98,%eax
